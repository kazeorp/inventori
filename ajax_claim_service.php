...
require 'session.php';
require 'koneksi.php';
require 'helpers.php'; // Pastikan file ini ada dan berisi fungsi e() dan pushWebSocketUpdate()
...
try {
    ...
    if ($stmt_get_inventori_status === false) {
        throw new Exception("Prepare 1A Gagal: " . mysqli_error($koneksi));
    }
    ...
    $stmt_update_service = mysqli_prepare(
        $koneksi,
        "UPDATE service_list
