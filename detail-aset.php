...
if (isset($_GET['cari']) && !empty($_GET['keyword'])) {
    ...
    // PASTIKAN SEMUA KOLOM TERBARU ADA DI QUERY INI
    ...
    <?php else: ?>
        ...
        <table class="table table-bordered w-100 mb-4">
            <tbody>
                ...
                <tr><th>Device Category</th><td><?= e($aset['device_category'] ?? '') ?></td></tr> <tr><th>Domain</th><td><?= e($aset['domain'] ?? '') ?></td></tr>                   <tr><th>RAM</th><td><?= e($aset['ram'] ?? '') ?></td></tr>
